...
(function(e, t) {
  ...
  return function(r) {
    ...
    f = function(e, t, n, o) {
      ...
      if (typeof n == "function") {
        ...
        for (b = 0; b < t.length; b++) {
          y = m(t[b], o), c = y.f;
          if (c === "require") a[b] = h(e);
          else if (c === "exports") a[b] = i[e] = {}, f = !0;
          else if (c === "module") l = a[b] = {
            id: e,
            uri: "",
            exports: i[e],
            config: g(e)
          };
          else if (i.hasOwnProperty(c) || s.hasOwnProperty(c)) a[b] = v(c);
          else if (y.p) y.p.load(y.n, h(o, !0), d(c), {}), a[b] = i[c];
          else if (!u[c]) throw new Error(e + " missing " + c)
        }
        p = n.apply(i[e], a);
        if (e) if (l && l.exports !== r && l.exports !== i[e]) i[e] = l.exports;
        else if (p !== r || !f) i[e] = p
      } else e && (i[e] = n)
    }, e = t = l = function(e, t, n, i) {
      return typeof e == "string" ? v(m(e, t).f) : (e.splice || (o = e, t.splice ? (e = t, t = n, n = null) : e = r), t = t ||
      function() {}, i ? f(r, e, t, n) : setTimeout(function() {
        f(r, e, t, n)
      }, 15), l)
    }, l.config = function(e) {
      return o = e, l
  ...
  }(), n("libs/almond", function() {}), function() {
    function C(e, t, n) {
  ...
  }.call(this), n("underscore", function(e) {
    return function() {
      return e._
    }
  }(this)), n("oats/events", ["underscore"], function(e) {
    var t = /\s+/,
      n = {
        on: function(e, n, r) {
          var i, s, o;
          if (!n) return this;
          e = e.split(t), i = this._callbacks || (this._callbacks = {});
        ...
        off: function(n, r, i) {
          ...
          if (!(n || r || i)) return delete this._callbacks, this;
    ...
    return n
  }), n("oats/Channels/local.receiver", ["underscore", "oats/events"], function(e, t) {
    function r(e, t) {
      if (typeof e[t] != "undefined") throw new Error("Timestamping over existing attribute: " + t);
      var n = new Date;
      return e[t] = Date.UTC(n.getUTCFullYear(), n.getUTCMonth(), n.getUTCDate(), n.getUTCHours(), n.getUTCMinutes(), n.getUTCSeconds(), n.getUTCMilliseconds()), e
    }
    function i() {
      var t = this;
      window.addEventListener("message", e.bind(function(e) {
        if (n(e.data)) {
          var t = r(e.data, "t_dispatch_rcvd");
          console.log("[LOCAL RECEIVER] got data", t), this.trigger("Receive", t)
        }
      }, this), !1)
    }
    var n = function(e) {
        return e.destination === "oats"
      };
    return e.extend(i.prototype, t, {}), i
  }), n("oats/api.specification", [], function() {
    return {
      isValidAction: function(e) {
        return this.actions.indexOf(e) !== -1
      },
      actions: ["swipe-left", "swipe-right", "swipe-up", "swipe-down", "tap", "hold", "release", "zoom-in", "zoom-out"],
      signals: {
      ...
      isValidSignal: function(e) {
        return [this.signals.CLIENT_REGISTER, this.signals.CLIENT_REGISTERED, this.signals.CLIENT_SYNCED, this.signals.CLIENT_OUT_OF_SYNC].indexOf(e) !== -1
      }
    }
  }), n("settings", [], function() {
    return {
      ...
      extensionCheckTimeout: 3e3,
      debug: !1
    }
  }), n("oats/client.bootstrap", ["oats/api.specification", "settings"], function(e, t) {
    function n() {
      return document.getElementById("remoats-plugin-installed") != null
    }
    function r() {
      var e = document.getElementById("remoats-plugin-installed");
      return e != null ? e.getAttribute("data-extension-id") : null
    }
    function i() {
      var e = document.getElementById("remoats-plugin-installed");
      return e != null ? e.getAttribute("data-widget-url") : null
    }
    function s(e) {
      this.widget = document.createElement("iframe");
      var t = this.widget;
      t.setAttribute("style", "border: none; position:fixed; z-index:10000; right:0; top:90px; width: 46px; height: 49px;"), t.setAttribute("id", "remotes-widget"), t.setAttribute("scrolling", "no"), t.setAttribute("src", e), window.addEventListener("message", function(e) {
        typeof e.data.destination != "undefined" && (e.data.destination === "widget" && (t.style.width = e.data.size.width, t.style.height = e.data.size.height), e.data.destination === "page" && t.contentWindow.postMessage(e.data, "*"))
      }, !1)
    }
    function o() {}
    return s.prototype = {
      ...
      check: function() {
        var e = this;
        setTimeout(function() {
          (new s(t.syncWidgetUrl)).render(), e.registerClient(), e.onReady()
        }, t.extensionCheckTimeout)
      },
      registerClient: function() {
        window.postMessage({
          signal: e.signals.CLIENT_REGISTER
        }, "*")
      },
      onReady: function() {}
    }, o
  }), n("oats/client", ["underscore", "oats/events", "oats/Channels/local.receiver", "oats/api.specification", "oats/client.bootstrap"], function(e, t, n, r, i) {
    function s(e) {
      var t = this,
        n = new i;
      n.onReady = function() {
    ...
    return e.extend(s.prototype, t, {
      __setupClient: function() {
        (new n).on("Receive", function(e) {
          if (typeof e.action != "undefined") {
            if (!r.isValidAction(e.action)) throw new Error("Invalid action: " + e.action);
            this.trigger(e.action, e.actionArgs)
          }
          if (typeof e.signal != "undefined") {
            if (!r.isValidSignal(e.signal)) throw new Error("Invalid signal: " + e.signal);
            switch (e.signal) {
            case r.signals.CLIENT_REGISTERED:
              this.trigger("ready");
              break;
            case r.signals.CLIENT_SYNCED:
              this.trigger("synced");
              break;
            case r.signals.CLIENT_OUT_OF_SYNC:
